...
```{r chromosome_plot, echo=FALSE, warning=FALSE, message=FALSE, results='hide', fig.width=8, fig.height=6}
v4_subg_jw <-
  subgenome %>%
...
segment_data <- segment_data %>% subset(Subgenome %in% c("Maize1", "Maize2", "orphan", "sub1dom", "sub2dom", "dom"))
centromere_data <- df1
...
ggsave("Output/Figure 1.png", plot = chromosome_plot)
