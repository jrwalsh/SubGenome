...
plot <- graphGenePairDominanceByExperiment(maize.walley.v4mapped.expression.data, homeologs.pairs, 4, FALSE)
plot(plot)
cap <- "Fig 9.1:"
```
...
factor <- 4
maize.walley.abundance.v4.data <- 
  maize.walley.abundance.v4 %>%
  select(geneID, sample, dNSAF_avg)
plot <- graphGenePairDominanceByExperiment(maize.walley.abundance.v4.data, homeologs.pairs, factor, FALSE) + 
...
maize.walley.v4mapped.expression.data <- 
  maize.walley.v4mapped.expression %>%
  select(geneID, sample, FPKM_avg)
plot <- graphGenePairDominanceByExperimentAcrossFactors(maize.walley.v4mapped.expression.data, homeologs.pairs, FALSE)
plot(plot)
cap <- "Fig 9.3:"
```
